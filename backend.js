...
io.on("connection", (socket) => {
  ...
  socket.on("keydown", ({ keycode, sequenceNumber }) => {
    ...
    if (playerSides.left < 0)
      // Checks to see if the player is out of bounds on the left side
    ...
    if (playerSides.right > GAME_WIDTH)
      // Checks to see if the player is out of bounds on the right side
    ...
    if (playerSides.top < 0)
      // Checks to see if the player is out of bounds on the top side
    ...
    if (playerSides.bottom > GAME_HEIGHT)
      // Checks to see if the player is out of bounds on the bottom side
